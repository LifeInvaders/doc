\subsection{Réseau}
    ...
    \subsubsection{Dernière soutenance}
		...
		\paragraph{Implémentation des pouvoirs en multijoueur}
			...
			Les pouvoirs sont maintenant présent en jeu! les 4 pouvoirs (lancer de couteau, déguisement, vitesse, et poison) sont tous paraitement fonctionnels et utilisable sur les PNJs

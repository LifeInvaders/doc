...
Panic At Tortuga est un jeu orienté multijoueur. Mais quel genre de jeu est-ce ?
...
Le début de production de notre équipe de développement, Lifeinvaders Production,
...
\section{Conception}
    ...
    Pour éviter de se perdre dans la masse de tâches à réaliser, nous avons décidé d'utiliser des
